...
"Annotations are available(the full list of form annotations)":annotations.textile to enhance the data entry form.  One of these is the "@FormField(more information on the @FormField annotation)":formFieldAnnotation.textile.  The @FormField annotation specifies:
