...
The "purchaseDate" shows the default value of "today".  "Defaults(more information on defaults)":defaults.textile  can also be calculated at runtime.

Annotations are available to enhance the data entry form.  One of these is the "@FormField(more information on the @FormField annotation)":formFieldAnnotation.textile.  The @FormField annotation specifies:
